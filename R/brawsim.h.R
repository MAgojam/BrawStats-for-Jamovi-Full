...
BrawSimOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    public = list(
        initialize = function(
            ...
            private$..meta4RepPower <- jmvcore::OptionNumber$new(
                ...
                meta4RepPower,
                default=0.9)
            private$..meta5Type <- jmvcore::OptionList$new(
                "meta5Type",
                meta5Type,
                options=list(
                    "Interaction",
            ...
            self$.addOption(private$..meta5Type)
    ...
    active = list(
        ...
        meta5Type = function() private$..meta5Type$value,
